...
';
$tplOuterCheckbox = '
    <div class="fltr_block fltr_block_checkbox fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
...
$tplOuterSingleCheckbox = '
    <div class="fltr_block fltr_block_checkbox fltr_block_single_checkbox fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
        <span class="fltr_name fltr_name_checkbox fltr_name[+tv_id+]">[+name+]</span>
        [+wrapper+]
    </div>
';
...
$tplOuterSelect = '
    <div class="fltr_block fltr_block_select fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
...
$tplOuterInterval = '
    <div class="fltr_block fltr_block_interval fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
...
$tplOuterRadio = '
    <div class="fltr_block fltr_block_radio fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
...
$tplOuterMultySelect = '
    <div class="fltr_block fltr_block_multy fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
...
$tplOuterSlider = '
    <div class="fltr_block fltr_block_slider fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
...
';
$tplOuterColors = '
    <div class="fltr_block fltr_block_checkbox fltr_colors fltr_block[+tv_id+] fltr_colors[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
        <span class="fltr_name fltr_name_checkbox fltr_name[+tv_id+]">[+name+]</span>
        [+wrapper+]
    </div>
';
...
';
$tplOuterPattern = '
    <div class="fltr_block fltr_block_checkbox fltr_pattern fltr_block[+tv_id+] fltr_pattern[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
        <span class="fltr_name fltr_name_checkbox fltr_name[+tv_id+]">[+name+]</span>
        [+wrapper+]
    </div>
';

...
$tplRowCheckbox = '
	<label class="[+disabled+]">
		<input type="checkbox" name="f[[+tv_id+]][]" value="[+value+]" [+selected+] [+disabled+]  onchange="document.getElementById(\'eFiltr\').submit();"> [+name+] <span class="fltr_count">[+count+]</span>
	</label>
';
$tplOuterCheckbox = '
...
//слайдер
$tplRowSlider = '<div style="display:none;">от<input type="text" id="minCostInp[+tv_id+]" name="f[[+tv_id+]][min]" value="[+minval+]" data-min-val="[+minvalcurr+]" onblur="document.getElementById(\'eFiltr\').submit();"> до <input type="text" id="maxCostInp[+tv_id+]" name="f[[+tv_id+]][max]" value="[+maxval+]" data-max-val="[+maxvalcurr+]" onblur="document.getElementById(\'eFiltr\').submit();"></div>';
$tplOuterSlider = '
...
$("#slider[+tv_id+]").slider({
	...
	stop: function(event, ui) {
		...
		document.getElementById("eFiltr").submit();
    },

<style>
	...
	.multitv #tv[+param_tv_id+]list .element label:nth-of-type(14){width:100px;position:relative;vertical-align:middle;display:inline-block;}
	.multitv #tv[+param_tv_id+]list .element label:nth-of-type(14):before{content:"Точное совпад";position:absolute;top:-20px;left:0;font-size:12px;}
	...
	.multitv #tv[+param_tv_id+]list .element label:nth-of-type(13){display:none;}

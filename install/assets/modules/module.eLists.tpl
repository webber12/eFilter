 ...
 * @internal    @properties &param_tv_id=ID TV параметров товара;string; &product_template_id=ID шаблона товара;string; &param_cat_id=ID категории параметров;string; &exclude_tvs_from_list=Не включать ТВ в параметры при выводе;string; &tovarChunkName=Имя чанка вывода товара;string;
